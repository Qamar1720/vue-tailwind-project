<template>
    <div class="flex flex-col md:flex-row gap-3 md:gap-0 justify-between border border-[#362943] bg-[#1A0B2E] mt-4 px-2 sm:px-0">
    ...
    <div class="border text-center mb-4 border-[#362943]">
      <ChartMainData2 :chartData="getChartData" />
    </div>
  </template>
  ...
  import ChartMainData2 from "./ChartMainData2.vue";
